...
var floor4 = $('.HuaWei_phone').eq(3).offset().top;
var floor5 = $('.HuaWei_phone').eq(4).offset().top;
var floor6 = $('.HuaWei_phone').eq(5).offset().top;
var floor7 = $('.HuaWei_phone').eq(6).offset().top;
var floor8 = $('.HuaWei_phone').eq(7).offset().top;
//楼层跳转消失
$(window).scroll(function() {
	...
	if (scrollTop >= floor4) {
		$('.floor-box .item').removeClass('border');
		$('.floor-box .item').eq(3).addClass('border');
	}
	if (scrollTop >= floor5) {
		$('.floor-box .item').removeClass('border');
		$('.floor-box .item').eq(4).addClass('border');
	}
	if (scrollTop >= floor6) {
		$('.floor-box .item').removeClass('border');
		$('.floor-box .item').eq(5).addClass('border');
	}
	if (scrollTop >= floor7) {
		$('.floor-box .item').removeClass('border');
		$('.floor-box .item').eq(6).addClass('border');
	}
	if (scrollTop >= floor8) {
		$('.floor-box .item').removeClass('border');
		$('.floor-box .item').eq(7).addClass('border');
	}
	if (scrollTop > 2070) {
